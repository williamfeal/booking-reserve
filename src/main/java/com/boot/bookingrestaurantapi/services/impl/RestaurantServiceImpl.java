...
public class RestaurantServiceImpl implements RestaurantService {
	...
	public RestaurantRest getRestaurantByName(String restaurantName) throws BookingException {
		return modelMapper.map(getRestaurantEntityName(restaurantName), RestaurantRest.class);
	}
	...
	private Restaurant getRestaurantEntityName(String restaurantName) throws BookingException {
