...
public class RestaurantController {
	...
	//si se quiere crear otra consulta de restaurante sin turnos se crea otro json quitando los turnos
	...
	@ResponseStatus(HttpStatus.OK)
	@RequestMapping(value = "restaurantn" + "/{" + "restaurantName"
			+ "}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public BookingResponse<RestaurantRest> getRestaurantByName(@PathVariable String restaurantName) throws BookingException {
		return new BookingResponse<>("Succes", String.valueOf(HttpStatus.OK), "OK",
